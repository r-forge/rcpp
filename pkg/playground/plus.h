...
namespace sugar{
	...
	class Plus_Matrix_Primitive : 
	    public Rcpp::MatrixBase<RTYPE,true, Plus_Matrix_Primitive<RTYPE,NA,T> > {
	public:
		...
		Plus_Matrix_Primitive( const VEC_TYPE& lhs_, STORAGE rhs_ ) : 
	...
	template <int RTYPE, bool NA, typename T> 
	struct plus_vector_primitive_result_type_trait{
	    typedef typename Rcpp::traits::if_<
	    	Rcpp::traits::matrix_interface<T>::value, 
	    	Plus_Matrix_Primitive<RTYPE,NA,T>, 
	    	Plus_Vector_Primitive<RTYPE,NA,T> 
	    >::type type ;
	} ;
...
template <int RTYPE,bool NA, typename T>
inline typename Rcpp::sugar::plus_vector_primitive_result_type_trait<RTYPE,NA,T>::type
operator+( 
	const Rcpp::VectorBase<RTYPE,NA,T>& lhs, 
	typename Rcpp::traits::storage_type<RTYPE>::type rhs 
) {
    typedef typename Rcpp::sugar::plus_vector_primitive_result_type_trait<RTYPE,NA,T>::type RES ;
	Rprintf( "%s\n", DEMANGLE(RES) ) ;
    Rprintf( "%s\n", DEMANGLE(T) ) ;
    return RES( lhs, rhs ) ;
}
